...
**It works out of the box, but it's designed to be made yours.** The categories, scoring weights, narrative framing, and deal-breakers are all customizable. You (Codex) can edit the user's files. The user says "change my focus areas to health equity" and you do it.
...
- `AGENTS.md`, `*.mjs` scripts, `templates/*`, `.Codex/skills/*`, `VERSION`
...
AI-powered grant search and application pipeline built on Codex: discovery via Grants.gov API, structured evaluation with eligibility gating, narrative generation, SF-424 assistance, budget building, and compliance tracking.
